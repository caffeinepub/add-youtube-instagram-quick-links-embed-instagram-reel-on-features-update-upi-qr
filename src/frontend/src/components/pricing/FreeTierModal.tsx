...
export default function FreeTierModal({ open, onOpenChange }: FreeTierModalProps) {
        ...
        <div className="space-y-4 pt-4">
          <div className="space-y-3">
            ...
            >
              <div className="flex items-center gap-3">
                ...
                <div className="text-left">
                  <div className="font-semibold text-base">Get it by WhatsApp</div>
                  <div className="text-xs opacity-90">Quick setup via WhatsApp</div>
                </div>
              </div>
            </Button>
            ...
            >
              <div className="flex items-center gap-3">
                ...
                <div className="text-left">
                  <div className="font-semibold text-base">Contact Our Team</div>
                  <div className="text-xs text-muted-foreground">+91 7014270402</div>
                </div>
              </div>
            </Button>
          </div>
          ...
          <div className="mt-6 p-4 bg-purple-500/10 border border-purple-400/30 rounded-lg">
            <p className="text-sm text-center text-muted-foreground">
              Our team will help you get started with your free 3-day trial of Zerox AI
            </p>
          </div>
        </div>
      </DialogContent>
